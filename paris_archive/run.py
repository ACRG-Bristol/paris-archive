...
def preprocess():
    ...
    zsf_ms_folder = data_file_path("", "paris", sub_path=paths.GCMS-Medusa-flask_path)
    ...
    bir_folder = data_file_path("", "paris", sub_path=paths.GCMS-Medusa-flask_path)
    ...
    # cmn_folder = data_file_path("", "paris", sub_path=paths.GCMS-Medusa-flask_path)
    ...
    # hun_folder = data_file_path("", "paris", sub_path=paths.GCMS-Medusa-flask_path)
    # os.chdir(hun_folder)
